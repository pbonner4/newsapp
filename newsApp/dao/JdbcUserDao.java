...
public class JdbcUserDao implements UserDao {
    ...
    @Override
    public void createGoogleUser(String username, String password, String role, String email, String firstName, String lastName) {
        String insertUserSql = "insert into users (username,password_hash,role,email, first_name, last_name) values (?,?,?,?,?,?);";

        jdbcTemplate.update(insertUserSql, username, " ", role, email, firstName, lastName);
