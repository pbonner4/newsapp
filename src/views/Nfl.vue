<template>
  <div class="container">
      ...
      <div>
        <!-- conditional rendering in mobile view -->
          <h1 class="heading-holder" v-if="newsOrTrendingClicked">NFL Section <i class="fa fa-duotone fa-football"></i></h1>
          ...
          <div class="main-area">
            ...
            <div class="nfl-scores" v-show="!toggleContentBasedCollaborativeBased || isDesktop"> 
              <NflScores></NflScores>
  ...
  import NflScores from '@/components/NflScores.vue';
  ...
  export default {
    ...
    beforeMount() {
      ...
      ArticleService.listNflArticles().then(response => {
