<template>
    <div class="container">
        ...
        <div>
          <!-- conditional rendering in mobile view -->
            <h1 class="heading-holder" v-if="newsOrTrendingClicked">The Left Wing <i class="fa fa-solid fa-democrat"></i></h1>
    ...
    export default {
      ...
      beforeMount() {
        ...
        ArticleService.listLeftWingArticles().then(response => {
