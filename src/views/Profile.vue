<template>
    <div class="container">
        ...
        <div>
          <!-- conditional rendering in mobile view -->
            <h1 class="heading-holder" v-if="newsOrTrendingClicked">Hello, {{ this.currentUsername }} <i class="fa-solid fa-user fa-sm"></i></h1>
            ...
            <div class="main-area">
              ...
              <h2 class = "trending-published">On: {{ articles.publishedAt }}</h2>
                ...
                <!-- profile information -->
                <div class = "profile-info" v-bind:class="{hidden: !isDesktop}" v-if="newsOrTrendingClicked">
                <userStatuses></userStatuses>
                <div class="post-history-container">
                    <userSaveForLaterPosts v-if="newsOrTrendingClicked"></userSaveForLaterPosts>
                    <userLikedPosts v-if="newsOrTrendingClicked"></userLikedPosts>
                    <userDislikedPosts v-if="newsOrTrendingClicked"></userDislikedPosts>
                    <LikedStatuses></LikedStatuses>
                </div>
            </div>
            <statusSidebar v-bind:class="{hidden: !isDesktop}" v-if="newsOrTrendingClicked"></statusSidebar>
            <profileDashboardMobile v-bind:class="{hidden: isDesktop}" v-if="newsOrTrendingClicked"></profileDashboardMobile>
              ...
              <div class = "news-grid-trending" v-if="!newsOrTrendingClicked">
                <div class = "article" v-for="article in trendingArticles" v-bind:key="article.articleId">
                  ...
                  <a v-on:click="pushToArticle(article.articleId)">
    ...
    import userLikedPosts from '@/components/userLikedPosts.vue';
    import userDislikedPosts from '@/components/userDislikedPosts.vue';
    import userSaveForLaterPosts from '@/components/userSaveForLaterPosts';
    import userStatuses from '@/components/userStatuses';
    import statusSidebar from '@/components/StatusSidebar';
    import LikedStatuses from '@/components/LikedStatuses.vue';
    import profileDashboardMobile from '../components/profileDashboardMobile.vue';
