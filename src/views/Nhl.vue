<template>
  <div class="container">
      ...
      <div>
        <!-- conditional rendering in mobile view -->
          <h1 class="heading-holder" v-if="newsOrTrendingClicked">The Hockey Rink <i class="fa-solid fa-hockey-puck"></i></h1>
          ...
          <div class="main-area">
            ...
            <div class="nhl-scores" v-show="!toggleContentBasedCollaborativeBased || isDesktop"> 
              <NhlScores></NhlScores>
  ...
  export default {
    ...
    beforeMount() {
      ...
      ArticleService.listNhlArticles().then(response => {
