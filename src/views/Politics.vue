<template>
  <div class="container">
      ...
      <div>
        <!-- conditional rendering in mobile view -->
          <h1 class="heading-holder" v-if="newsOrTrendingClicked">Politics Section:</h1>
          ...
          <div class="main-area">
            ...
            <div class = "trending-articles"  v-for="articles in trendingArticles" v-bind:key="articles.articleId">
              <div class = "trending-article-grid">
                <div class="trending-image-section">
                  <!-- __blank temporaryo redirects outside of web app -->
                  <a v-bind:href=articles.url target="_blank">
              <img class="trending-article-image" v-lazy=articles.urlToImage alt="trending-article-image">
            </a>
            </div>
            ...
            <div class = "news-grid" v-if="newsOrTrendingClicked">
      ...
      <nav class = "trending-nav">
              <ul class="trending-nav-list">
                <button class="trending-nav-news-button" v-bind:disabled="newsOrTrendingClicked" v-on:click="toggleTrendingAndNews()">
                  <i class="fa-solid fa-duotone fa-newspaper fa-lg" v-bind:class="{'i-changed': this.newsOrTrendingClicked}"></i>
                </button>
                <button class="trending-nav-trending-button" v-bind:disabled="!newsOrTrendingClicked" v-on:click="toggleTrendingAndNews()">
                  <i class="fa-solid fa-arrow-trend-up fa-lg" v-bind:class="{'i-changed': !this.newsOrTrendingClicked}"></i>
                </button>
                <button class="trending-nav-search-button">
                  <i class="fa-solid fa-magnifying-glass fa-lg"></i>
                </button>
                <router-link v-bind:to="{ name: 'profilePage'}" style="margin-top: 13px;">
  ...
  export default {
    ...
    beforeMount() {
      ...
      ArticleService.listPoliticsArticles().then(response => {
