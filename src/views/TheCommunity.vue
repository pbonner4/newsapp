<template>
    <div class="container">
        ...
        <div>
          <!-- conditional rendering in mobile view -->
            <h1 class="heading-holder" v-if="newsOrTrendingClicked">The Barbershop <i class="fa fa-solid fa-message"></i></h1>
    ...
    import CommunityStatuses from '@/components/CommunityStatuses.vue';
    import BottomNavigation from '@/components/BottomNavigation.vue';

    export default {
      name: "theCommunityPage",
      components: {
        navBar,
        MobileNavbar,
        CommunityStatuses,
      ...
      beforeMount() {
        ...
        ArticleService.listTvArticles().then(response => {
