<template>
  <div class="container">
      ...
      <div>
        <!-- conditional rendering in mobile view -->
          <h1 class="heading-holder" v-if="newsOrTrendingClicked">The Octagon <i class="fa fa-solid fa-dumbbell"></i></h1>
          ...
          <div class="main-area">
            ...
            <div class="mma-scores" v-show="!toggleContentBasedCollaborativeBased || isDesktop"> 
              <MmaScores v-show="!toggleContentBasedCollaborativeBased || isDesktop"></MmaScores>
              <FutureMmaEvents v-show="!toggleContentBasedCollaborativeBased || isDesktop"></FutureMmaEvents>
  ...
  import MmaScores from '@/components/MmaScores.vue';
  import FutureMmaEvents from '@/components/FutureMmaEvents.vue';
  ...
  export default {
    ...
    beforeMount() {
      ...
      ArticleService.listMmaArticles().then(response => {
