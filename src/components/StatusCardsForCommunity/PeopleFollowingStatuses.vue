              ...
              <div class = "status" v-for="status in displayStatuses" v-bind:key="status.id">
                  <div class="username-date">
                    <div class="user-follow-container">
                      ...
                      <button v-on:click="unfollowAUser(status.user_id)" v-if="peopleFollowing.some(f => f.user_followed === status.username)" class="following-button">Unfollow</button>
                    </div>
                      <h6>{{ status.date }}</h6>
                  </div>
                  <h6 class="status-text">{{ status.status }}</h6>
                  <h6 class="status-text">{{ status.subject_tagged }}  
                    <i id="dollar" v-if="status.subject_tagged == 'Business'" class="fa fa-sack-dollar "></i>
                    <i id="landmark" v-if="status.subject_tagged == 'Politics'" class="fa fa-light fa-landmark"></i>
                    <i id="film" v-if="status.subject_tagged == 'Movies'" class="fa fa-solid fa-film"></i>
                    <i id="basketball" v-if="status.subject_tagged == 'Nba'" class="fa-sharp fa-solid fa-basketball"></i>
                    <i id="football" v-if="status.subject_tagged == 'Nfl'" class="fa fa-duotone fa-football"></i>
                    <i id="puck" v-if="status.subject_tagged == 'Nhl'" class="fa-solid fa-hockey-puck"></i>
                    <i id="tv" v-if="status.subject_tagged == 'Tv'" class="fa fa-solid fa-tv"></i>
                    <i id="dumbbell" v-if="status.subject_tagged == 'MMA'" class="fa fa-solid fa-dumbbell"></i>
                    <i id="music" v-if="status.subject_tagged == 'Music'" class="fa fa-solid fa-music"></i>
                    <i id="film" v-if="status.subject_tagged == 'In Theaters'" class="fa fa-solid fa-film"></i>
                </h6>
...
import FriendRequestService from '@/services/FriendRequestService';
  ...
  async mounted() {
    ...
    StatusService.getPeopleFollowing().then(response => {
