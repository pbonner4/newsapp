<template>
          ...
          <div class="team-stats" v-if="activeIndex == index"> 
              <table>
                  ...
                  <tr>
                      ...
                      <th>{{ event.competitions[0].competitors[0].statistics[0].name }}</th>
                      <th>{{ event.competitions[0].competitors[0].statistics[0].displayValue }}</th>
                  </tr>
                  <tr>
                      <th>{{ event.competitions[0].competitors[1].statistics[1].displayValue }}</th>
                      <th>{{ event.competitions[0].competitors[0].statistics[1].name }}</th>
                      <th>{{ event.competitions[0].competitors[0].statistics[1].displayValue }}</th>
                  </tr>
                  <tr>
                      <th>{{ event.competitions[0].competitors[1].statistics[3].displayValue }}</th>
                      <th>{{ event.competitions[0].competitors[0].statistics[3].name }}</th>
                      <th>{{ event.competitions[0].competitors[0].statistics[3].displayValue }}</th>
                  </tr>
                  <tr>
                      <th>{{ event.competitions[0].competitors[1].statistics[5].displayValue }}</th>
                      <th>{{ event.competitions[0].competitors[0].statistics[5].name }}</th>
                  ...
                  <tr>
                      ...
                      <th>{{ event.competitions[0].competitors[0].statistics[6].name }}</th>
  ...
  export default {
      ...
      async mounted() {
          LiveScores.listNhlScores().then(response => {
