...
<h1 v-on:click="showLikes = true" v-show="showLikes == false">Show Disliked Posts <i class="fa-solid fa-caret-right"></i></h1>
              <h1 v-on:click="showLikes = false" v-show="showLikes == true">Hide Disliked Posts <i class="fa-solid fa-caret-down"></i></h1>
              ...
              <div class = "article" v-for="article in displayArticles" v-bind:key="article.id">
                ...
                <div class = "buttons">
                  <button v-on:click="postLiked = article.id; handleLikeClick(article.id)">
                    <i class="fa fa-down-up fa-regular" v-bind:class="{'i-changed': articleIsLiked(article.id)}">
                    </i></button>
                </div>
              </div>
          </div>
