<template>
    <div>
      <div id = "content-suggestions">
                <h2 class="header">You Might Be Interested in:</h2>
              ...
              <div class="content-information-section">
                <div class="content-title-container">
                  ...
                  <a  v-on:click ="pushToArticle(articles.categorySpecified, articles.title, articles.id)">
                    <h4 class = "content-title" v-on:click="postClicked=articles.id; logArticleClick()">{{articles.title}}</h4>
                  </a>
            </div>
              </div>
  ...
  export default {
    ...
    async mounted(){
      ...
      ArticleService.listFwlsArticles().then(response => {
